  ...
  return (
    <div className="max-w-sm mx-auto px-6 py-16">
      <div className="text-center mb-8">
        <h1 className="text-xl font-bold text-text mb-1">Sign in to AgentPack Hub</h1>
        <p className="text-xs text-text-muted">Welcome back. Import and publish in one click.</p>
      </div>
      ...
      <div className="mt-6 border-t border-border pt-6">
        <button
          onClick={() => { toast('GitHub OAuth — redirecting...', 'info'); setTimeout(() => { toast('Signed in with GitHub!'); navigate('/dashboard') }, 1000) }}
